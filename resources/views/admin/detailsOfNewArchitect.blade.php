    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark"> طراح</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="{{$architect->name}}" disabled>
                                </div>
                                <div class="form-group">
                                    <label>نام کاربری(شماره موبایل)</label>
                                    <div class="inline_flex width-100">
                                        <input id="username" class="form-control" value="{{$architect->mobile}}"
                                               disabled>
                            ...
                            <div class="card-footer">
                                ...
                                <a class="btn btn-primary"  href="{{route('home')}}">خروج</a>
                            </div>
                            <div id="social_medias" style="display: none;transition: 0.3s ease-out"
                                 class="inline_flex ">
                                {!! $socialShare !!}
                            </div>
                        </div>
