            ...
            <div class="card">
                @if(!empty($architects))
                    <div class="card-header">
                        <h3 class="card-title">لیست طراحان</h3>
                        ...
                        <table class="table table-striped projects">
                            ...
                            @foreach($architects as $architect)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{count($architect->customers())}}
                                    </td>
                                    <td>
                                        {{$architect->getCreatedAtInPersian()}}
                                    </td>
                                    <td class="project-actions  ">
                                        <a class="btn btn-info btn-sm" href="{{route('admin.singleArchitect',$architect->id)}}">
                                            <i class="fas fa-eye">
                                            </i>
                                            مشاهده
                                        </a>
