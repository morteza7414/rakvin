    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">معرفی مشتری</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#}">خانه</a></li>
                            <li class="breadcrumb-item active">معرفی مشتری</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <!-- end error handling -->
        <!-- message handling -->
        @if ($message = Session::get('createUser'))
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="card-footer">
                            <button type="button" class="btn btn-primary" data-dismiss="alert">خروج</button>
                            <button type="button" class="btn btn-primary">ارسال پیام</button>
                            <button type="button" class="btn btn-primary">کپی</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card card-primary">
                            ...
                            <form role="form" method="post" action="{{route('store.customer')}}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">نام ساختمان</label>
