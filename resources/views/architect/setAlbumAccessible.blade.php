                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">
                                ویرایش دسترسی مشتریان به آلبوم {{$album->name}}
                            </li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
        ...
        <section class="content">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">مشتریان دارای دسترسی را انتخاب کنید</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="col-12">
                        <form method="post" action="{{route('store.album.accessible',$album->id)}}">
                            @csrf
                                        ...
                                        <td>
                                            @if($customer->isAccessToAlbum($album->id))
                                                <input type="checkbox" value="true" checked="checked"
                                                       name="isAccess{{$customer->id}}">
                                            @else
                                                <input type="checkbox" value="false" name="isAccess{{$customer->id}}">
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
